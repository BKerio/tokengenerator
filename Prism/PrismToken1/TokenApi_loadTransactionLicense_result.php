...
class TokenApi_loadTransactionLicense_result
{
    ...
    {
        return 'TokenApi_loadTransactionLicense_result';
    }
    ...
    {
        $xfer = 0;
        $xfer += $output->writeStructBegin('TokenApi_loadTransactionLicense_result');

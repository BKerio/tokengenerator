...
class TokenApi_issueSetControlToken_result
{
    ...
    {
        return 'TokenApi_issueSetControlToken_result';
    }
    ...
    {
        $xfer = 0;
        $xfer += $output->writeStructBegin('TokenApi_issueSetControlToken_result');
